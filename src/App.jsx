...
export function App() {
  ...
  return (
   ...
   <button onClick={handleSubmit} className="bg-orange w-full py-3 rounded-full text-sm font-bold uppercase tracking-1 hover:bg-white hover:text-orange cursor-pointer"
   >Submit</button>
   ...
   <p className="mb-6 text-orange bg-dark-blue 
   w-fit mx-auto px-3 py-1.25 rounded-3xl text-sm">You selected {nota} out of 5</p>
